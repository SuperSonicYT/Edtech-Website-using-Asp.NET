...
namespace SkillVertex_Learning_Portal.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,EmailAddress,Subject,Message")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,EmailAddress,Subject,Message")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
